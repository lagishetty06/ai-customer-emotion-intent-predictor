...
class EmotionResponseBot:
    ...
    OFFLINE_RESPONSES = {
        ...
        ("NEUTRAL", "CANCELLATION"): "I can help you with your cancellation request. Please share your account or subscription details so we can assist you.",
        ...
        ("FRUSTRATED", "CANCELLATION"): "I understand this is frustrating. Please share your subscription details so we can help resolve your cancellation request.",
        ...
        ("ANGRY", "CANCELLATION"): "I completely understand your frustration. I am escalating your cancellation request directly to our customer retention team for immediate assistance.",
    }
    ...
    def generate_offline_response(self, emotion: str, intent: str) -> str:
        ...
        # Fallback by intent matching (using NEUTRAL tone as baseline)
        neutral_key = ("NEUTRAL", normalized_intent)
        if neutral_key in self.OFFLINE_RESPONSES:
            neutral_response = self.OFFLINE_RESPONSES[neutral_key]
            if normalized_emotion == "HAPPY":
                # Ensure no duplicate smiley emoji if one is already present
                suffix = "" if neutral_response.endswith("😊") else " 😊"
                return neutral_response + suffix
            elif normalized_emotion == "FRUSTRATED":
                prefix = "I understand this is frustrating. "
                if neutral_response.lower().startswith("i understand"):
                    return neutral_response
                return prefix + neutral_response
            elif normalized_emotion == "ANGRY":
                prefix = "I completely understand your frustration. "
                if neutral_response.lower().startswith("i completely understand"):
                    return neutral_response
                return prefix + neutral_response
            return neutral_response
